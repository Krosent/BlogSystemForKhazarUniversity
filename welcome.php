...
<!-- Latest compiled and minified JavaScript -->
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="welcome.php">NEWS</a>
    </div>
    ...
    <div id="mainBlock">
       ...
       if(isset($_GET['function'])) {
        ...
        <form class="forms" method="post" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
            ...
            //INSERT INTO NEWS
                   ...
                   if(isset($_POST['add'])){
                      require "dbConn.php";
                                $R=$_SESSION['login'];
                            $sql="INSERT INTO news (news_title,news_short_description,news_full_content,news_published_on,user_id,news_image) VALUES('$title','$short_desc','$full_content',CURRENT_TIMESTAMP(),'$R','$image')";
             ...
             <button class="btn btn-default pull-center" name="last_edit">Confirm</button>
               ...
               <?php  
                ...
                <div style="float-left;">
                    <div class="row">
                    <form class="forms" method="post" action="">
                    <select class="form-control" name="view_news">
                            <?php
                  ...
                  <br>
                            ...
                            <br>
                            <button class="form-control" class="btn btn-defult" name="add_tag">Add tags</button>
                        </form>
                 </div>
                    <?php
...
require 'dbConn.php';
$sql_table = "SELECT * FROM news";
$query_table = mysqli_query($dbc, $sql_table);
?>
<div class="" style=" transform: translateY(15%);
                border:1px solid white;
                padding:15px;
                border-radius:2px;
                background-color: #B3B4B5;
  ...
  <table class="table">
    ...
    <tbody>
<?php
while($fetch_table = mysqli_fetch_assoc($query_table)) {
       ?>

      <tr>
        <td><?php echo $fetch_table['news_id'] ?></td>
        <td><?php echo $fetch_table['news_title'] ?></td>
        <td><?php echo $fetch_table['news_published_on'] ?></td>
      </tr>
